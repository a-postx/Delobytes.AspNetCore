...
public static class ConfigurationBuilderExtensions
{
    ...
    /// <param name="ifAction">Action used to add to the configuration pipeline if the condition is
    /// <c>true</c>.</param>
    /// <param name="elseAction">Action used to add to the configuration pipeline if the condition is
    /// <c>false</c>.</param>
    /// <returns>The same configuration builder.</returns>
